...
!write(*,*) lbl_xeta(ilbl),kappa
   ...
   real(dp) function lbl_emissivity(T,p,xs,w)
      ...
      lines_loop: do ilbl=1,lbl_nlines
         ...
         !Planck function
         Ib = Planck_function(T,lbl_xeta(ilbl))
...
!   endsubroutine reduce_spectrum
   ...
   subroutine get_lbl_rnr(T_in,p_in,xs_in,ofile,binary_output,&
      ...
      use physical_functions, only: Planck_function,kappa_eta_soot
      use precision_parameters, only: dp,small
      implicit none
      ...
      lines_loop: do ilbl=1,nlbl                                        !Main loop
         ...
         Ib = Planck_function(T_in,lbl_xeta(ilbl))
...
!            do itg=1,ntg
!               Ib = Planck_function(T_in(itg),xeta)                         !Spectral blackbory radiative intensity
...
!      call CheckMemAlloc('',ierr)
      ...
      lbl_loop: do ilbl=1,nlbl
         ...
         tb_loop_0: do itb=1,ntb
            Ibeta(itb) = &
               Planck_function(Tb_array(itb),lbl_xeta(ilbl))*lbl_deta(ilbl)
   ...
   subroutine generate_box_kappa(&
      ...
      ts_loop: do its=1,nts
         ...
         do ilb=llb,ulb
            ...
            !Planck function
            Ib = Planck_function(T_array(itg),lbl_xeta(ilb))
